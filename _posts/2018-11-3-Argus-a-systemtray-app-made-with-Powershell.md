...
- the incorporation of my other tool, the [TCP\IP-printtool](https://kristofstroobants.github.io/Deploying-TCPIP-printers-with-a-Powershell-GUI/)
...
Anyway, with the Helpdesk-button on the top and the wheel-cog on the bottom left, I had most of my features implemented. The gray wheel cog will open a fly-in menu that has the option to install a printer. This would open the [TCP\IP-printtool](https://kristofstroobants.github.io/Deploying-TCPIP-printers-with-a-Powershell-GUI/) I wrote about.
